...
class WarehousesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create warehouse" do
    assert_difference('Warehouse.count') do
      post warehouses_url, params: { warehouse: { count: @warehouse.count, name: @warehouse.name, stockedIngredients_id: @warehouse.stockedIngredients_id } }
    end
  ...
  test "should update warehouse" do
    patch warehouse_url(@warehouse), params: { warehouse: { count: @warehouse.count, name: @warehouse.name, stockedIngredients_id: @warehouse.stockedIngredients_id } }
